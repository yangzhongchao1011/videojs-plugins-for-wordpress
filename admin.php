...
function videojs_menu() {
	...
	$videojs_admin = add_options_page('Video.js Settings', 'Video.js 设置', 'manage_options', 'videojs-settings', 'videojs_settings');
...
function register_videojs_settings() {
	...
	add_settings_section('videojs_defaults', '默认设置', 'defaults_output', 'videojs-settings');
	
	add_settings_field('videojs_width', '宽', 'width_output', 'videojs-settings', 'videojs_defaults');
	add_settings_field('videojs_height', '高', 'height_output', 'videojs-settings', 'videojs_defaults');
	
	add_settings_field('videojs_preload', '预缓存视频', 'preload_output', 'videojs-settings', 'videojs_defaults');
	add_settings_field('videojs_autoplay', '自动播放', 'autoplay_output', 'videojs-settings', 'videojs_defaults');
	
	add_settings_field('videojs_responsive', '响应式视频窗口', 'responsive_output', 'videojs-settings', 'videojs_defaults');
	
	add_settings_field('videojs_cdn', '使用CDN?', 'cdn_output', 'videojs-settings', 'videojs_defaults');
	
	add_settings_field('videojs_color_one', '图标颜色', 'color_one_output', 'videojs-settings', 'videojs_defaults');
	add_settings_field('videojs_color_two', '进度条颜色', 'color_two_output', 'videojs-settings', 'videojs_defaults');
	add_settings_field('videojs_color_three', '背景颜色', 'color_three_output', 'videojs-settings', 'videojs_defaults');
	
	add_settings_field('videojs_video_shortcode', '使用[video]短代码?', 'video_shortcode_output', 'videojs-settings', 'videojs_defaults');
	
	add_settings_field('videojs_reset', '恢复默认使插件 停用/激活', 'reset_output', 'videojs-settings', 'videojs_defaults');
}
